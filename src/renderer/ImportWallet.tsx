            ...
            >
              <a
                className="
                      ...
                      px-3
                      mb-1
                      text-gray-600 text-sm text-primary-orange
                      bg-primary-orange bg-opacity-10
                      transition
                      ease-in-out
                      duration-200
                    "
                href="/fullpage.html#/import-wallet/seed-phrase"
              >
                Seed Phrase
              </a>
              <a
                className="
                      ...
                      duration-200
                    "
                href="/fullpage.html#/import-wallet/keystore-file"
              >
                Keystore File
              </a>
            </div>
              ...
              <div className="w-full flex flex-col mb-4">
                ...
                >
                  ...
                  <span
                    ...
                    style={{ maxWidth: '90%' }}
                  >
                    Mnemonic. Your secret 12 - 24 words phrase.
                  </span>
                </label>
